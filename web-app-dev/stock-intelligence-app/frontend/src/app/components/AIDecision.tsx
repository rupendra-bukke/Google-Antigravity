...
export default function AIDecision({ symbol, spotPrice = null }: { symbol: string; spotPrice?: number | null }) {
    ...
    return (
        ...
        >
            ...
            <ExpiryZeroHeroSection symbol={symbol} spotPrice={spotPrice} />
        </div>
    );
}
...
function ExpiryZeroHeroSection({ symbol, spotPrice }: { symbol: string; spotPrice: number | null }) {
    ...
    return (
        <div style={{ marginTop: "1rem", border: "1px solid rgba(251,146,60,0.25)", borderRadius: "14px", padding: "0.9rem", background: "rgba(251,146,60,0.05)" }}>
